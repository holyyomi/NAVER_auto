    ...
    <div className="space-y-6 pt-1">
      <section className="panel rounded-2xl px-6 py-6">
        <div className="flex items-end justify-between gap-4 border-b border-[var(--line)] pb-5">
          ...
          <StatusBadge tone="active">3개</StatusBadge>
        </div>
          ...
          {activeFeatures.map((feature) => {
            ...
            return (
              <Link
                key={feature.slug}
                href={feature.href}
                className="group flex min-h-[280px] flex-col rounded-2xl border border-[var(--line)] bg-[var(--bg-elevated)] px-5 py-5 transition-all hover:-translate-y-0.5 hover:border-[var(--line-strong)] hover:bg-[var(--bg-soft)]"
              >
