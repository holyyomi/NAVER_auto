...
export const allFeatures: FeatureDefinition[] = [
  {
    ...
    title: "검색 결과 모음",
    shortDescription: "검색 결과를 모아 보고 복사하거나 저장합니다.",
    description: "키워드별 검색 결과를 확인하고 필요한 항목만 정리하는 작업 화면입니다.",
    status: "usable",
  ...
  },
  {
    ...
    title: "검색광고 리포트 보조",
    shortDescription: "성과 수치를 입력하면 공유용 리포트 문안을 정리합니다.",
    description: "검색광고 수치를 기준으로 요약, 문제점, 다음 액션을 정리하는 화면입니다.",
    status: "usable",
  ...
  },
  {
    ...
    title: "광고 운영 보조",
    shortDescription: "운영 이슈를 입력하면 오늘 할 액션을 정리합니다.",
  ...
  },
  {
    ...
    title: "지역 업체 조사",
    shortDescription: "지역과 업종 기준으로 실무용 검색 결과를 확인합니다.",
  ...
  },
  {
    ...
    title: "경쟁 키워드 모니터링",
    shortDescription: "저장한 키워드의 노출 여부 변화를 반복 확인합니다.",
    description: "이전 검색 결과와 현재 결과를 비교해 노출 변화만 확인하는 화면입니다.",
    status: "usable",
  ...
  },
  {
    ...
    slug: "keyword-trends",
    title: "키워드 트렌드",
    shortDescription: "현재 범위에서 제외된 기능입니다.",
